            ...
            <footer className='container-fluid footer-bg full-pad'>
                <div className="row">
                    <div className="col-lg-4 col-sm-5">
                        ...
                        <p><FaMobileAlt className='f-icon'></FaMobileAlt>085656345770</p>
                    ...
                    <div className="col-lg-3 col-sm-3 pb-4 general-link">
                    ...
                    <div className="col-lg-5 col-sm-4 pb-4 input">
                        <form>
                            ...
                            <textarea name="address" cols="5" rows="100" placeholder='Leave a massage for us' className='w-100 t-6 mb-4'></textarea><br />
                    ...
                    <hr className='text-white mt-4 mb-2' />
