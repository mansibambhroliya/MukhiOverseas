        ...
        <section>
          <div className='about-sec full-pad'>
            <div className="row about-space container-fluid">
              ...
              <div className="col-md-6 col-sm-12 d-flex justify-content-md-end align-items-md-center mini-name fw-bold text-white pb-3">
        ...
        <section className='mt-4'>
          <div className="row contact-sec container-fluid ">
            ...
            <div className="col-md-3 col-sm-12 ">
              <div>
                <div className='ps-4 font-darkcyan fw-bold fs-6 prod-div'>
                  <p><Link to="/products" className='font-darkcyan'>Contact Us</Link></p>
                </div>

                <div className='contact mb-5'>
                  <p className='ms-4'>M. D. Sharma</p>
                  ...
                  <div className='d-flex'>
                    ...
                    <p><Link>mukhioverseas@gmail.com</Link></p>
                  </div>
                  <div className='d-flex '>
                    <span><GiEarthAfricaEurope className='cont-icon'></GiEarthAfricaEurope></span>
                    <span className=''><Link to="https://www.exportersindia.com/mukhi-overseas/" className='text-wrap'>
                      https://www.exportersindia.com/mukhi-overseas/</Link></span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-9 px-3 ">
              <div className='pad cont-bg'>
                <div>
                  <p className='fs-5'>Send Us a Message</p>
                </div>
                <form  name='valForm' onSubmit={ myValidation} action="#">
                  <div className='row'>

                    <div className="col-md-6 col-sm-12 div-border">
                      <span>*</span>
                    ...
                    <div className="col-md-6 col-sm-12 div-border">
                      <span>*</span>
                      <select class="form-select"  id="country" name="country" className='' >
