                    ...
                    <div className="col-md-6 col-sm-12 d-flex justify-content-end">
                        <div className='d-flex'>
                            ...
                            <div >
                                ...
                                <button type="button" class="btn mail-btn me-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body d-flex justify-content-center btn1">
                                                    <div>
                                                        <div className='d-flex '>
                            ...
                            <div>
                                {/* <!-- Button trigger modal --> */}
                                <button type="button" class="sms-btn mail-btn me-3" data-bs-toggle="modal" data-bs-target="#sms">
